	...
	return {
		...
		actions: {
			...
			register: async(datas) =>{
				try{
					let response = await fetch("https://turbo-computing-machine-976qx59xpp5wcx777-3001.app.github.dev/api/register",{
						method: "POST",
			...
			login: async(infoLogin)=>{
				try{
					const response = await fetch("https://turbo-computing-machine-976qx59xpp5wcx777-3001.app.github.dev/api/login",{
						method: "POST",
			...
			getList: async () => {
				...
				try{
					let response = await fetch("https://turbo-computing-machine-976qx59xpp5wcx777-3001.app.github.dev/api/users",{
						headers:{
			...
			logout:() => {
				...
				setStore({...getStore(),userList: [] });//limpia la lista de usuarios
